...
def get_supported_vision_models():
    ...
    try:
        ...
        # Liste avec variantes tiret et underscore
        return {
            'aria', 'aya_vision', 'blip', 'blip-2', 'chameleon', 'cohere2vision',
            'deepseek-vl', 'deepseek_vl', 'deepseek-vl-hybrid', 'emu3', 'evolla', 'florence2',
            ...
            'llava-next', 'llava_next', 'llava-next-video', 'llava-onevision', 'mistral3',
            'mllama', 'ovis2', 'paligemma', 'perception-lm', 'pix2struct',
            'pixtral', 'qwen2.5-vl', 'qwen2_5_vl', 'qwen2-vl', 'qwen2_vl', 
            'qwen3-vl', 'qwen3_vl', 'qwen3-vl-moe',
